char LANG_LOWADDR [] __attribute__(   (  aligned( 1 ), section( ".data" )  )   ) = "開始あどれす:";
char LANG_HIGHADDR [] __attribute__(   (  aligned( 1 ), section( ".data" )  )   ) = "終了あどれす:";
char LANG_COMMENT [] __attribute__(   (  aligned( 1 ), section( ".data" )  )   ) = "こーど名:";
...
char LANG_NOTFOUND [] __attribute__(   (  aligned( 1 ), section( ".data" )  )   ) = "さーち失敗   ";
char LANG_PRESS1 [] __attribute__(   (  aligned( 1 ), section( ".data" )  )   ) = "○/×で継続...  ";
char LANG_RESTITLE [] __attribute__(   (  aligned( 1 ), section( ".data" )  )   ) = "あどれす 8bit 16bit  32bit ";
...
char LANG_RESP4 [] __attribute__(   (  aligned( 1 ), section( ".data" )  )   ) ="△めもり  ";
...
char LANG_PRESSSKEY [] __attribute__(   (  aligned( 1 ), section( ".data" )  )   ) ="ぼたん変更...";
